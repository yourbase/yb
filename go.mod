...
require (
	...
	github.com/fsouza/go-dockerclient v1.6.7-yourbase
...
replace github.com/fsouza/go-dockerclient v1.6.7-yourbase => github.com/yourbase/go-dockerclient v1.6.7-0.20201208171014-27676b7fda6c
